      ...
      body: Column(
        children: [
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: widget.car['vendor']['image'] != null 
                                  ? NetworkImage("https://res.cloudinary.com/dcs2edizr/image/upload${widget.car['vendor']['image'] ?? '/images/default.png'}") 
          ...
          // Partie fixe en bas avec animation
            ...
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              color: Theme.of(context).bottomAppBarTheme.color, // Adapté au dark mode
              border: Border(
                top: BorderSide(
                  color: Theme.of(context).dividerColor, // Adapté au dark mode
                  width: 1,
                ),
              ),
              boxShadow: [
              ...
              children: [
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                    color: Theme.of(context).hintColor, // Texte adapté
                  ),
                ),
                const SizedBox(height: 4),
                Text(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: AppColors.primary, // Garde votre couleur primaire
